...
public class deletar extends  JDesktopPane{
    public deletar(){
        ...
        //labels
        JLabel lbtext5= new JLabel("Deletar");
        JLabel lbnumero= new JLabel("TIPO DE OBJECTO");
        JLabel lbtipo= new JLabel("ID");
...
//        painel2.add(btnstatus2).setBounds(260,400,80,25);
        ...
        //butpes
        JButton btnentrar = new JButton("Deletar");
    ...
    public void deletar(JTextField t1,JTextField t2){
        String retorno="";
        String sql = " delete from "+t1.getText()+" where idQuarto='"+t2.getText()+"';";
        String idsql= "select * from "+t1.getText()+" where idquarto='"+t2.getText()+"';";
